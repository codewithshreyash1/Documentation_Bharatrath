    ...
    <div class="footer-content">
      <div class="footer-social">
        ...
        <div class="social-icons">
          <a
            href="https://www.linkedin.com/company/bharatrath/mycompany/"
            target="_blank"
            rel="noopener"
            aria-label="LinkedIn"
          >
          ...
          <a
            href="https://www.instagram.com/bharatrath_/"
            target="_blank"
            rel="noopener"
          ...
          <a
            href="https://www.youtube.com/@bharatrath5685"
            target="_blank"
            rel="noopener"
            aria-label="YouTube"
          >
      ...
      <div class="footer-copyright">
        <p>© Ashti Ventures Private Limited. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
</template>
